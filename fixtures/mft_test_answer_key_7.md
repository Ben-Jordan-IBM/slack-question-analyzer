...
## Convention update (v2.44)

The three AI-agent questions are no longer expected in the review pile —
taxonomy v4 added an "AI & Automation" bucket (that recurring capability
area WAS the emerging-category signal; adding the bucket is the designed
response). They must now route there confidently. The routing-humility
checks in key 6 (wiki/holiday-hours/too-vague -> review) still guard
